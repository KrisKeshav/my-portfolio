...
export default function GithubHeatmap() {
  return (
    <div className="h-full flex flex-col rounded-2xl border border-border/80 bg-surface/50 backdrop-blur-sm p-6 overflow-x-auto shadow-sm hover:shadow-md transition-shadow duration-300">
